...
(0, globals_1.describe)('AvroSerializer', () => {
    ...
    (0, globals_1.it)('basic encryption with wrapped union', async () => {
        ...
        (0, globals_1.expect)(obj2.result["com.acme.Data"].secret).toEqual(obj.result["com.acme.Data"].secret);
    });
    ...
    (0, globals_1.it)('basic encryption with dek rotation', async () => {
        const fieldEncryptionExecutor = encrypt_executor_1.FieldEncryptionExecutor.registerWithClock(new FakeClock());
        fieldEncryptionExecutor.executor.clock.fixedNow = Date.now();
        let conf = {
            baseURLs: [baseURL],
            cacheCapacity: 1000
        };
        ...
        fieldEncryptionExecutor.executor.clock.fixedNow += 2 * 24 * 60 * 60 * 1000;
